...
import Select from "../views/Components/Select/index";
import Cascader from "../views/Components/Cascader";
import Editor from "../views/Practice/Editor";
import ReduxToolkit from "../views/Practice/Redux/ReduxToolkit";
...
const routes: any = [
  ...
  },
  {
    ...
    exact: true,
    name: "动态增减嵌套字段",
    component: FormAddSubtractFields,
    auth: [1],
    meta: {
      login: true,
      content: true,
